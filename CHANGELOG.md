...
- Interaction Demo FPS rig: reads `DemoInput.LookDelta` (core 0.4.8) for gamepad look with a
  deadzone, a curve and frame-rate independence. The sensitivity field scales the shared
  mouse feel.
